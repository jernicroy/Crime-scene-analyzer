...
% Last Modified by GUIDE v2.5 26-Mar-2021 17:02:35
...
email=get(handles.edit1,'String')
password=get(handles.edit2,'String')
if(strcmp(email,'admin'))
    if(strcmp(password,'admin'))
        closereq;
        cbires()
    else if(isempty(password))
            errordlg('Please enter a valid password:')
        end
    end
else
    errordlg('Please Enter the Correct Credientals')
end
